        ...
        <div className="ph__content">
          ...
          <div className="ph__top">
            ...
            <div className="ph__names">
              ...
              <h1 className="ph__username">
                ...
                {profile.isPremium && (
                  <span
                    className="ph__badge ph__badge--premium"
                    title="Premium"
                  >
                    <FiStar size={11} />
                    Premium
                ...
                {profile.isAdmin && (
                  <span
                    className="ph__badge ph__badge--admin"
                    title="Administrator"
                  >
          ...
          <div className="ph__stats">
            ...
            <div className="ph__stat">
              <span className="ph__stat-val">
                {
                  detailedInfo?.userChallenges?.filter(
                    (c: any) => c.isCompleted
                  ).length ?? 0
                }
              </span>
