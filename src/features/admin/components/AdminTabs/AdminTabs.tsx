// src/features/admin/components/AdminTabs/AdminTabs.tsx
import React from 'react';
import { FiUsers, FiBarChart2, FiAward, FiMessageCircle } from 'react-icons/fi';
import './AdminTabs.css';

export type AdminTab = 'users' | 'stats' | 'challenges' | 'support';
...
const TABS: { key: AdminTab; label: string; icon: React.ElementType }[] = [
  ...
  { key: 'support',    label: 'Підтримка',   icon: FiMessageCircle  },
];
